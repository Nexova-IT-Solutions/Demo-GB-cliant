...
export async function getShippingConfig(client: RawShippingConfigClient): Promise<ShippingConfigRecord | null> {
  const rows = await client.$queryRawUnsafe<Array<Record<string, unknown>>>(
    'SELECT "id", "deliveryFee", "freeDeliveryThreshold", "isFreeDeliveryEnabled", "expressDeliveryFee", "isDeliveryEnabled", "deliveryNote", "hideOutOfStockProducts", "hideEmptyCategories", "updatedAt" FROM "ShippingConfig" WHERE "id" = $1 LIMIT 1',
...
export async function ensureShippingConfig(client: RawShippingConfigClient): Promise<ShippingConfigRecord> {
  ...
  await client.$executeRawUnsafe(
    'INSERT INTO "ShippingConfig" ("id", "deliveryFee", "freeDeliveryThreshold", "isFreeDeliveryEnabled", "expressDeliveryFee", "isDeliveryEnabled", "deliveryNote", "hideOutOfStockProducts", "hideEmptyCategories", "updatedAt") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, CURRENT_TIMESTAMP) ON CONFLICT ("id") DO NOTHING',
    DEFAULT_SHIPPING_CONFIG.id,
...
export async function upsertShippingConfig(
  ...
  const updatedCount = await client.$executeRawUnsafe(
    'UPDATE "ShippingConfig" SET "deliveryFee" = $1, "freeDeliveryThreshold" = $2, "isFreeDeliveryEnabled" = $3, "expressDeliveryFee" = $4, "isDeliveryEnabled" = $5, "deliveryNote" = $6, "hideOutOfStockProducts" = $7, "hideEmptyCategories" = $8, "updatedAt" = CURRENT_TIMESTAMP WHERE "id" = $9',
    deliveryFee,
  ...
  if (updatedCount === 0) {
    await client.$executeRawUnsafe(
      'INSERT INTO "ShippingConfig" ("id", "deliveryFee", "freeDeliveryThreshold", "isFreeDeliveryEnabled", "expressDeliveryFee", "isDeliveryEnabled", "deliveryNote", "hideOutOfStockProducts", "hideEmptyCategories", "updatedAt") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, CURRENT_TIMESTAMP)',
      DEFAULT_SHIPPING_CONFIG.id,
      deliveryFee,
      freeDeliveryThreshold,
      isFreeDeliveryEnabled,
